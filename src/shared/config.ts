...
!process.env.GOOGLE_CLIENT_ID ? process.env.GOOGLE_CLIENT_ID = '' : null;
!process.env.GOOGLE_CLIENT_SECRET ? process.env.GOOGLE_CLIENT_SECRET = '' : null;
!process.env.GOOGLE_REDIRECT_URL ? process.env.GOOGLE_REDIRECT_URL = 'http://localhost:3000/auth/login/google-redirect' : null;

!process.env.APPLE_CLIENT_ID ? process.env.APPLE_CLIENT_ID = '' : null;
!process.env.APPLE_TEAM_ID ? process.env.APPLE_TEAM_ID = '' : null;
!process.env.APPLE_KEY_ID ? process.env.APPLE_KEY_ID = '' : null;
!process.env.APPLE_REDIRECT_URL ? process.env.APPLE_REDIRECT_URL = 'http://localhost:3000/auth/login/apple-redirect' : null;

!process.env.FACEBOOK_CLIENT_ID ? process.env.FACEBOOK_CLIENT_ID = '' : null;
!process.env.FACEBOOK_CLIENT_SECRET ? process.env.FACEBOOK_CLIENT_SECRET = '' : null;
